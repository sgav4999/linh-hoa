...
where title = 'The Insurance Contract'
  ...
  and content not like '%A few more terms tied to the validity of%';
...
where title = 'Insurance Producers and Distribution'
  ...
  and content not like '%Agents are also classified by residency:%';
...
where title = 'Premiums and Rating'
  ...
  and content not like '%Paying more often than annually costs mo%';
...
where title = 'Medicare and Medicare Supplement'
  ...
  and content not like '%A senior who is still covered under an e%';
...
where title = 'Medicare and Medicare Supplement'
  ...
  and content not like '%When filing a Medicare claim, the medica%';
...
where title = 'Coordination of Benefits and Group Administration'
  ...
  and content not like '%Vision care insurance usually covers eye%';
...
where title = 'Coordination of Benefits and Group Administration'
  ...
  and content not like '%Coordination of benefits applies to medi%';
...
where title = 'Health Plan Types and Cost Sharing'
  ...
  and content not like '%Morbidity is the principle of the likeli%';
...
where title = 'Coordination of Benefits and Group Administration'
  ...
  and content not like '%Eligible individuals can obtain group he%';
...
where title = 'Group Health Insurance Laws'
  ...
  and content not like '%HiCAP counselors complete an intensive t%';
...
where title = 'Disability Income Insurance and Social Security'
  ...
  and content not like '%For a disability income policy, bodily i%';
...
where title = 'Long-Term Care Insurance and Workers'' Compensation'
  ...
  and content not like '%Long-term care riders can also include a%';
...
where title = 'Long-Term Care Insurance and Workers'' Compensation'
  ...
  and content not like '%When an agent writes a replacement long-%';
...
where title = 'Long-Term Care Insurance and Workers'' Compensation'
  ...
  and content not like '%Workers'' compensation medical expense be%';
...
where title = 'Types of Life Insurance'
  ...
  and content not like '%Selling Variable Universal life (or any %';
...
where title = 'Types of Life Insurance'
  ...
  and content not like '%Endowment insurance is a related product%';
...
where title = 'Business and Estate Uses of Life Insurance'
  ...
  and content not like '%Tax treatment note: individual disabilit%';
...
where title = 'Life Insurance Policy Provisions'
  ...
  and content not like '%Policy loans taken against the cash valu%';
...
where title = 'Retirement Plans and Annuities'
  ...
  and content not like '%Other examples of qualified plans includ%';
...
where title = 'Retirement Plans and Annuities'
  ...
  and content not like '%Before recommending an annuity, the prod%';

-- Verify: lists every lesson touched and whether each gap's guard text now appears.
select title, module_id,
  (content like '%A few more terms tied to the validity of%') as gap_1,
  (content like '%Agents are also classified by residency:%') as gap_2,
  (content like '%Paying more often than annually costs mo%') as gap_3,
  (content like '%A senior who is still covered under an e%') as gap_4,
  (content like '%When filing a Medicare claim, the medica%') as gap_5,
  (content like '%Vision care insurance usually covers eye%') as gap_6,
  (content like '%Coordination of benefits applies to medi%') as gap_7,
  (content like '%Morbidity is the principle of the likeli%') as gap_8,
  (content like '%Eligible individuals can obtain group he%') as gap_9,
  (content like '%HiCAP counselors complete an intensive t%') as gap_10,
  (content like '%For a disability income policy, bodily i%') as gap_11,
  (content like '%Long-term care riders can also include a%') as gap_12,
  (content like '%When an agent writes a replacement long-%') as gap_13,
  (content like '%Workers'' compensation medical expense be%') as gap_14,
  (content like '%Selling Variable Universal life (or any %') as gap_15,
  (content like '%Endowment insurance is a related product%') as gap_16,
  (content like '%Tax treatment note: individual disabilit%') as gap_17,
  (content like '%Policy loans taken against the cash valu%') as gap_18,
  (content like '%Other examples of qualified plans includ%') as gap_19,
  (content like '%Before recommending an annuity, the prod%') as gap_20
from public.lessons
